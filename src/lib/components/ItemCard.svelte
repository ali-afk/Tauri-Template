<script lang="ts">
/** Card displaying a single item with image, name, and optional link.
 *  Uses loadPriority for fetchpriority/loading eager-vs-lazy strategy.
 *  Items above the fold (first N) get "high" priority. */
